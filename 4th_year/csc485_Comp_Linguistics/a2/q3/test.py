...
VP_Aux -> Aux_Vt_pp Vm_pp | Aux_Vt_pp AdvP Vm_pp
VP_Aux -> Aux_Vt_gp Vm_gp | Aux_Vt_gp AdvP Vm_gp
...
Vm_sp_that -> 'told' | 'saw' | 'believed' |  'reminded'
Vd_sp_that -> 'told' | 'reminded'

 """)

sentence = "Nadia always believed before Ross arrived".split()
parser = nltk.BottomUpChartParser(grammer)
